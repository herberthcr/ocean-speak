...
const es = {
    ...
    timeUpHint: 'El nivel se reinicia — tus cartas se conservan',
    retry: '↺ Reintentar',
    toMenu: 'Menú ▶',
    ...
    voiceNoHeard: '🤔 No te oí, otra vez',
    voiceDenied: '🎤 Micrófono bloqueado',
    review: '✨ Repaso',
...
const en: typeof es = {
    ...
    timeUp: "Time's up!",
    timeUpHint: 'The level restarts — your cards are safe',
    retry: '↺ Retry',
    toMenu: 'Menu ▶',
    ...
    voice: '🎤 Voice',
    listening: 'Listening…',
    voiceNoHeard: "🤔 Didn't catch that, again",
